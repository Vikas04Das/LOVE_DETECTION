import cv2
import os
os.chdir(R'C:\Users\Vikas\Desktop\CUTM FILE\1ST YEAR\2ND SEM\6 MACHINE LEARNING USING PYTHON\Class Work\PROJECT\LOVE DEMO\FIND LOVE\New folder')
...
genderList=['LOVE','  ']
ageList=['(30%)','(85%)','(60%)','(70%)','(80%)','(90%)','(100%)','(60-100)']
